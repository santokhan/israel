    ...
    return (
        <div className="py-12 lg:py-20">
            <div className="w-full max-w-screen-xl mx-auto px-4 space-y-6">
                <div className="flex flex-wrap sm:gap-x-8 gap-y-8 lg:gap-y-12 justify-evenly">
                    {flexData.map((e, i) =>
                        <Link href={e.link} className="w-full sm:max-w-xs text-app-black hover:text-app-green space-y-3" key={i}>
                            <div className="">
